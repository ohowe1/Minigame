...
public class MiniGameManager {
    ...
    public void startGame() {
        ...
        try {
            Constructor<? extends MiniGame> constructor = currentMiniGameClass.getConstructor(ArrayList.class, Plugin.class, World.class, MiniGameManager.class);
            currentMiniGame = constructor.newInstance((ArrayList<Player>) getPlayingPlayers(), plugin, world, this);
        } catch (InstantiationException | IllegalAccessException | NoSuchMethodException | InvocationTargetException e) {
            e.printStackTrace();
            plugin.getPluginLogger().log(ChatColor.RED + "Could not initialize the " + currentMiniGameClass.getSimpleName() + " minigame. Please report this to that minigame's developer!");
            return;
        }
